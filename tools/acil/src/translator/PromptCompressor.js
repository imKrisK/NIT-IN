...
exports.PromptCompressor = exports.InputFormat = void 0;
const types_1 = require("../core/types");
const SemanticEquivalenceChecker_1 = require("./SemanticEquivalenceChecker");
var InputFormat;
(function (InputFormat) {
    InputFormat["CHAT"] = "CHAT";
    InputFormat["INSTRUCT"] = "INSTRUCT";
    InputFormat["COMPLETION"] = "COMPLETION";
})(InputFormat || (exports.InputFormat = InputFormat = {}));
class PromptCompressor {
    _checker;
    constructor(opts = {}) {
        this._checker = new SemanticEquivalenceChecker_1.SemanticEquivalenceChecker(opts);
    }
    /**
    ...
    compress(raw, sessionType) {
        ...
        const effectiveThreshold = sessionType === types_1.SessionType.DEBUGGING ? 0.30 : 0.72;
    ...
    _extractCoreTask(text) {
        ...
        if (questionMatch)
            return text; // Already imperative
    ...
    _compressStackTrace(text) {
        const lines = text.split('\n');
        const essential = lines.filter(line => line.includes('Error:') ||
