...
exports.ControlledHallucinationEngine = void 0;
...
const DEFAULT_CONFIG = {
    ...
    activateOnStates: [types_1.EnforcementState.CRITICAL, types_1.EnforcementState.WARNING],
};
class ControlledHallucinationEngine {
    _config;
    _shadowFn = null;
    _cache = new Map();
    _callCount = 0;
     ...
     */
    async measure(originalPrompt, compressedPrompt, sessionType, modelCostPerKTok, enforcementState) {
        ...
        try {
            ...
            const shadow = await this._shadowFn(compressedPrompt, this._config.shadowModelId, Math.min(2048, Math.ceil(origTokens * 2)));
    ...
    // ── Private ───────────────────────────────────────────────────────────────
    _estimate(orig, comp, sessionType, costPerKTok) {
...
exports.ControlledHallucinationEngine = ControlledHallucinationEngine;
